...
В современном мире, учитывая, что 80% своего времени человек тратит на работу, большую актуальность в бытовом плане приобретают удобные сервисы-помощники. Автомобиль уже давно не роскошь, а средство передвижения - удобный атрибут, и 99% населения предпочитают выбирать данный продукт с удобством для себя. 

Рассмотрим 2 существующих сайта подбора автомобилей: autospot и autopragmat.
Анализируя сервисные возможности autospot можно отметить, что данный сайт даёт возможность пользователю самостоятельно осуществлять поиск без регистрации: 
- раздел "авто с пробегом" вывогдит на экран ключевые параметры для подбора авто, заполнив их формируется список вариантов.
- есть удобная функция "autospot рекомендует". В один клик на необходимый параметр происходит сортировка и запускается поиск нужных вариантов продукта.
- есть сортировка, где можно установить приоритетные критерии поиска (5). 

Рассмотрев сервисные возможности сайта autopragmat, можно отметить что данный ресурс позволяет пользователю сформировать заявку с учетом определенных критериев для поиска нужных вариантов продукта. Данный вид услуг предполагает обработку данных специалистом по подбору. На сайте есть раздел, позволяющий ознакомиться с ассортиментом продуктов, ранее реализованных конкретному покупателю, что позволяет быстрее сформировать потребность в похожем продукте (6).
...
5. Автоспот ру - uWed [Электронный ресурс]. / - Сайт – Режим доступа: https://autospot.ru/ / свободный доступ – Дата доступа: 22.11.2021.

6. Автопрогмат - uWed [Электронный ресурс]. / - Сайт – Режим доступа: https://autopragmat.ru/ / свободный доступ – Дата доступа: 23.11.2021.
